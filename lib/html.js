...
function pagina({ titulo, corpo, usuario, interna, descricao }) {
  return `<!doctype html>
<html lang="pt-BR"><head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">
<title>${e(titulo)} · TRIPAC Negócios Imobiliários</title>
<meta name="description" content="${e(descricao || "Locação e venda de imóveis em Caraguatatuba e região.")}">
...
<header class="topo">
  ...
  <nav>
    ${interna
      ? `<a href="/interna">Captações</a><a href="/interna/contatos">Contatos</a><a href="/" target="_blank" rel="noopener">Ver o site</a><a href="/interna/sair">Sair</a>`
...
function cartaoImovel(imovel) {
  ...
  return `<a class="cartao-imovel" href="/imovel/${e(imovel.codigo)}">
    ${capa ? `<img src="${e(capa.url)}" alt="" loading="lazy">` : `<div class="sem-foto">sem foto</div>`}
    <div class="dados">
...
function listaPublica({ titulo, subtitulo, imoveis, busca, acao }) {
  return pagina({
    titulo,
    descricao: subtitulo,
...
function paginaImovel(imovel) {
  ...
  return pagina({
    ...
    corpo: `<article class="imovel">
      ...
      <div class="galeria">${fotos.map((f) => `<img src="${e(f.url)}" alt="" loading="lazy">`).join("")}</div>
...
module.exports = { e, pagina, cartaoImovel, listaPublica, paginaImovel };
